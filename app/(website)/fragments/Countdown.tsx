  ...
  return (
    <div className="flex flex-col items-center justify-center md:mt-12 p-4 rounded-3xl bg-white md:bg-transparent md:shadow-none sm:bg-glass-bg sm:backdrop-blur-md sm:shadow-glass-shadow">
      <h1 className="text-xl md:text-3xl font-semibold flex gap-2 justify-center items-center md:mb-4 text-primary font-BeVietnamPro">
        ...
        <MessageQuestion size={20}  className="text-sm cursor-pointer" onClick={() => setShowModal(!showModal)} />
      </h1>
      <div className="flex space-x-4 text-center">
        <div className="p-2 bg-zinc-200 rounded-lg">
          <span className="text-3xl font-semibold font-GeistMono text-primary">{timeLeft.days}</span>
          <div className="text-sm text-text">Days</div>
        </div>
        <div className="p-2 bg-zinc-200 rounded-lg">
          <span className="text-3xl font-semibold font-GeistMono text-primary">{timeLeft.hours}</span>
          <div className="text-sm text-text">Hours</div>
        </div>
        <div className="p-2 bg-zinc-200 rounded-lg">
          <span className="text-3xl font-semibold font-GeistMono text-primary">{timeLeft.minutes}</span>
          <div className="text-sm text-text">Minutes</div>
        </div>
        <div className="p-2 bg-zinc-200 rounded-lg">
          <span className="text-3xl font-semibold font-GeistMono text-primary">{timeLeft.seconds}</span>
      ...
      {showModal && (
        <div className="absolute flex flex-col items-center justify-start mt-12 w-[315px] bg-white rounded-3xl ">
          <div className="text-sidebar py-4 px-1 rounded-lg ">
            <h2 className="text-xl font-BeVietnamPro font-medium">Contact Information</h2>
            <p className="mb-2 font-BeVietnamPro text-sm">For more information, please contact</p>
            <p className='font-CabinetGrotesk font-semibold'>+233 55 511 1333 · +233 20 191 1493</p>
